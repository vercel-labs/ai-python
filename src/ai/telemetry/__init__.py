...
class RunSpanData:
    """One ``Agent.run``: the whole loop, steps nested underneath."""
...
class StepSpanData:
    ...
    span_name: ClassVar[str] = "step"


@dataclasses.dataclass
class ModelCallSpanData:
    ...
    span_name: ClassVar[str] = "model_call"


@dataclasses.dataclass
class GenerateSpanData:
    ...
    span_name: ClassVar[str] = "generate"
...
async def span(
    ...
    **attributes: Any,
    ...
    Pass a name plus attributes for a user span, or a ``*SpanData``
