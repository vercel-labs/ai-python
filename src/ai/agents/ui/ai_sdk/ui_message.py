...
class UIToolInvocationPart(pydantic.BaseModel):
    ...
    provider_executed: bool | None = pydantic.Field(
...
class UIToolApproval(pydantic.BaseModel):
    ...
    is_automatic: bool | None = pydantic.Field(
        default=None, alias="isAutomatic"
    )
...
class UIToolPart(pydantic.BaseModel):
    ...
    tool_metadata: dict[str, Any] | None = pydantic.Field(
        default=None, alias="toolMetadata"
    )
