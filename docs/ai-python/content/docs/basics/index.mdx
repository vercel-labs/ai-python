...
- `examples/models/tools_schema.py` passes a schema-only tool to a model.
- `examples/agents/agent_simple.py` runs the default agent loop.
- `examples/agents/agent_custom_loop.py` overrides `Agent.loop`.
- `examples/agents/streaming_tool.py` streams partial output from a tool.
- `examples/agents/agent_nested.py` runs a subagent as a tool.

End-to-end demos live in
[`examples/apps/fastapi-vite`](https://github.com/vercel-labs/ai-python/tree/main/examples/apps/fastapi-vite),
[`examples/apps/multiagent-textual`](https://github.com/vercel-labs/ai-python/tree/main/examples/apps/multiagent-textual),
and [`examples/apps/temporal-direct`](https://github.com/vercel-labs/ai-python/tree/main/examples/apps/temporal-direct).
