...
Use `experimental_evaluate` to ask choice, score, and boolean questions about one shared state:
...
print(result.value.answers)
```

This is specifically to support [Jev](https://vercel.com/ai-gateway/models/jev).
