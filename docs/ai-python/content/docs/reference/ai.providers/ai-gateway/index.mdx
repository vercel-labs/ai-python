...
- Image, video, and speech generation, embeddings, transcription, reranking, and evaluation through `ai.ops`.
...
- `evaluate(...)`: Evaluates typed questions against shared state.
